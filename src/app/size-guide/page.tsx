...
export default function SizeGuidePage() {
  return (
    <div className="min-h-screen bg-white pb-20">
      ...
      <section className="container mx-auto px-6 max-w-6xl mt-8">
        <div className="flex flex-col lg:flex-row gap-10 items-start">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="border border-gray-100 rounded-xl p-5 bg-[#f8f9fa]">
                  ...
                  <h3 className="text-sm font-bold text-[#0F2C3E] mb-2">Match to the chart</h3>
                  <p className="text-xs text-gray-500 leading-relaxed">Use your circumference (cm) to find your size in the chart. <strong>If you fall between two sizes, always size up.</strong> Bangles should slide over the hand with slight resistance — not cut into skin.</p>
                </div>
          ...
          {/* Right — Size Chart Image */}
          <div className="w-full lg:w-72 xl:w-80 shrink-0 lg:sticky lg:top-24">
            <div className="rounded-2xl overflow-hidden shadow-md border border-[#F8C8DC]/40">
              <Image
                src="/size-guide.png"
                alt="Bangles Size Guide Chart"
                width={720}
                height={1080}
