...
export default function JournalPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* ✅ FIXED: Slim Editorial Hero — reduced py, font size, and removed blur blob */}
      <section className="relative py-4 md:py-6 bg-[#fff1f2] overflow-hidden">
        <div className="container mx-auto px-6 text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
            <span className="text-[#db2777] text-[11px] font-bold tracking-[0.5em] uppercase mb-2 block">
              The Journal
            </span>
            <h1 className="text-3xl md:text-4xl font-serif text-[#0F2C3E] mb-2">
              Our <span className="italic font-semibold text-[#d92b7a]">Stories</span>
            </h1>
            <p className="text-gray-500 max-w-xl mx-auto font-light leading-relaxed text-sm">
              ...
              {posts.map((post) => (
                ...
                >
                  <Link href={`/blog/${post.slug}`} className="flex flex-col h-full">
                    {/* Cover Image */}
                    <div className="relative h-48 overflow-hidden bg-[#F9FAFB]">
                      <Image
