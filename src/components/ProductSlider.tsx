...
const ProductSlider = ({ products }: { products: any[] }) => {
  ...
  const handleDragMove = (clientX: number) => {
    ...
    el.scrollLeft = dragScrollLeft.current - (clientX - dragStartX.current)
  }
    ...
    <section className="bg-[#FFF0F5] py-6 overflow-hidden">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="hidden md:flex absolute left-2 top-1/2 -translate-y-1/2 z-20 items-center justify-center w-9 h-9 rounded-full bg-white/95 shadow-md border border-[#F8C8DC] text-[#0F2C3E] hover:border-[#db2777] hover:text-[#db2777] transition-all active:scale-95"
        >
          <ChevronLeft size={18} />
        </button>
        ...
        <button
          ...
          className="hidden md:flex absolute right-2 top-1/2 -translate-y-1/2 z-20 items-center justify-center w-9 h-9 rounded-full bg-white/95 shadow-md border border-[#F8C8DC] text-[#0F2C3E] hover:border-[#db2777] hover:text-[#db2777] transition-all active:scale-95"
        >
        ...
        <div
          ref={trackRef}
          className="flex gap-3 md:gap-5 py-3 px-4 overflow-x-auto scroll-smooth cursor-grab active:cursor-grabbing select-none [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
